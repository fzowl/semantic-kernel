...
"""Example demonstrating VoyageAI by MongoDB text embeddings with Semantic Kernel."""
...
async def main():
    """Run the VoyageAI by MongoDB text embedding example."""
    ...
    texts = [
        ...
        "VoyageAI by MongoDB provides high-quality embeddings",
