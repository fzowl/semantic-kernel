...
"""Example demonstrating VoyageAI by MongoDB multimodal embeddings with Semantic Kernel."""
...
async def main():
    """Run the VoyageAI by MongoDB multimodal embedding example."""
    ...
    # Available models:
    #   - voyage-multimodal-3.5: Latest model with text, image, and video support
    #   - voyage-multimodal-3 (legacy): Text and image embeddings
