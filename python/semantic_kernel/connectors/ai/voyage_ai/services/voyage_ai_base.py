...
class VoyageAIBase(AIServiceClientBase):
    """Base class for VoyageAI by MongoDB services."""
    ...
    def _create_async_client(self, settings: VoyageAISettings):
        ...
        # The official voyageai client selects the base URL from the API key prefix
        # (get_default_base_url): keys starting with "al-" are routed to
        # https://ai.mongodb.com/v1, all others to https://api.voyageai.com/v1.
        # We rely on that built-in redirection instead of reimplementing it here.
