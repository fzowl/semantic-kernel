...
/// <summary>
/// Provides extension methods for <see cref="IServiceCollection"/> to configure VoyageAI by MongoDB connectors.
/// </summary>
...
public static class VoyageAIServiceCollectionExtensions
{
    ...
    /// <param name="modelId">The VoyageAI by MongoDB model ID (e.g., "voyage-4-large", "voyage-code-4").</param>
    ...
    /// </summary>
    /// <param name="services">The <see cref="IServiceCollection"/> instance to augment.</param>
    /// <param name="modelId">The VoyageAI by MongoDB model ID (e.g., "voyage-context-4").</param>
    /// <param name="apiKey">The VoyageAI by MongoDB API key.</param>
    /// <param name="endpoint">Optional API endpoint. When not set, it is derived from the API key:
    /// keys starting with "al-" use https://ai.mongodb.com/v1, otherwise https://api.voyageai.com/v1.</param>
    /// <param name="serviceId">A local identifier for the given AI service.</param>
    ...
    /// </summary>
    /// <param name="services">The <see cref="IServiceCollection"/> instance to augment.</param>
    /// <param name="modelId">The VoyageAI by MongoDB model ID (e.g., "rerank-2.5", "rerank-2.5-lite").</param>
    /// <param name="apiKey">The VoyageAI by MongoDB API key.</param>
    /// <param name="endpoint">Optional API endpoint. When not set, it is derived from the API key:
    /// keys starting with "al-" use https://ai.mongodb.com/v1, otherwise https://api.voyageai.com/v1.</param>
    /// <param name="serviceId">A local identifier for the given AI service.</param>
